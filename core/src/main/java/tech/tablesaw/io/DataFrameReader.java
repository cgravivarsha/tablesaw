...
public class DataFrameReader {
	...
	TablesawReader<?> reader = registry.getReaderForMimeType(mimeType);
	return reader.read(new Source(connection.getInputStream()));
    }

    public Table string(String s, String extension) throws IOException {
	TablesawReader<?> reader = registry.getReaderForExtension(extension);
	...
	TablesawReader<?> reader = registry.getReaderForOptions(options);
